...
# -----------------------------------------------------------------------------
Write-Host "`n [2/4] Verificando aislamiento de rutas..." -ForegroundColor Yellow
...
if ($rootFiles) {
    Write-Host " ADVERTENCIA: Archivos JS sueltos en raíz detectados. Deberían moverse a /src o /scripts:" -ForegroundColor Red

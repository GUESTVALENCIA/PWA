...
export function safeLocalStorageGet(key, defaultValue = null) {
    if (!isLocalStorageAvailable()) {
        console.warn(` localStorage no disponible, usando defaultValue para: ${key}`);
        return defaultValue;
    }
    ...
    try {
        ...
        console.warn(` Error obteniendo de localStorage (${key}):`, e);
        return defaultValue;
    }
}
...
export function safeLocalStorageSet(key, value) {
    if (!isLocalStorageAvailable()) {
        console.warn(` localStorage no disponible, no se puede guardar: ${key}`);
        return false;
    }
    ...
    try {
        ...
        if (e.name === 'QuotaExceededError') {
            console.warn(' Cuota de localStorage excedida, intentando limpiar...');
...
export function safeLocalStorageRemove(key) {
    ...
    try {
        ...
        console.warn(` Error eliminando de localStorage (${key}):`, e);
        return false;
    }
}
...
export function safeLocalStorageGetJSON(key, defaultValue = null) {
    ...
    try {
        ...
        console.warn(` Error parsing JSON de localStorage (${key}):`, e);
        return defaultValue;
    }
}
...
export function safeLocalStorageSetJSON(key, value) {
    ...
    try {
        ...
        console.warn(` Error stringifying JSON para localStorage (${key}):`, e);
        return false;
    }
}
 ...
 */
export function safeLocalStorageKeys() {
    if (!isLocalStorageAvailable()) {
        return [];
    }
...
export function safeSessionStorageGet(key, defaultValue = null) {
    ...
    try {
        ...
        console.warn(` Error obteniendo de sessionStorage (${key}):`, e);
        return defaultValue;
    }
}
...
export function safeSessionStorageSet(key, value) {
    ...
    try {
        ...
        console.warn(` Error guardando en sessionStorage (${key}):`, e);
        return false;
    }
}

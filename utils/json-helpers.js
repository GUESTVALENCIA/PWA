 ...
 */
export function safeJSONParse(str, defaultValue = null, logError = true) {
    ...
    if (typeof str !== 'string') {
        try {
            ...
            if (logError) {
                console.warn(' Error convirtiendo a string para JSON.parse:', e);
            }
            return defaultValue;
        }
    }
 ...
 */
export function safeJSONStringify(obj, defaultValue = '{}', logError = true) {
    ...
    try {
        ...
        if (logError) {
            console.warn(' Error stringifying JSON:', {
                error: e.message,
 ...
 */
export function safeJSONParseLines(text, onLine = null, defaultValue = null) {
    const results = [];
        ...
        if (parsed !== defaultValue) {
            ...
            if (typeof onLine === 'function') {
                try {
                    ...
                    console.warn(' Error en callback onLine:', e);
                }
            }
        }
    }
